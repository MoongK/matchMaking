...
public class MobAttack : StateMachineBehaviour {
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        //animator.transform.rotation = Quaternion.Lerp(animator.transform.rotation, Quaternion.LookRotation(mc.attacker.transform.position), 4f * Time.deltaTime); //doesn't work
        Debug.Log("zombie!");
    }
